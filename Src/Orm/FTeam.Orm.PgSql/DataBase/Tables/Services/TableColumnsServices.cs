...
namespace FTeam.Orm.PgSql.DataBase.Tables.Services
{
    public class TableColumnsServices : ITableColumnsRules
    {
        ...
        public async Task<IEnumerable<TableColumns>> TryGetTableColumnsAsync(string tableName, PgSqlDbConnectionInfo PgSqlDbConnectionInfo)
        ...
        public IEnumerable<TableColumns> TryGetTableColumns(string tableName, PgSqlDbConnectionInfo PgSqlDbConnectionInfo)
        {
            string query = $"SELECT IS_NULLABLE as [Nullable],DATA_TYPE as [Type],COLUMN_NAME as [Column] FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME =  '{tableName}'";
        ...
        public IEnumerable<TableColumns> GetTableColumns(string tableName, PgSqlDbConnectionInfo PgSqlDbConnectionInfo)
        {
            try
            {
        ...
        public async Task<IEnumerable<TableColumns>> GetTableColumnsAsync(string tableName, PgSqlDbConnectionInfo PgSqlDbConnectionInfo)
        => await Task.Run(async () =>
        {
            try
            {
